package com.ofoegbuvgmail.funbaking.ui.widget;
...
import com.ofoegbuvgmail.funbaking.data.RecipeContract.RecipeEntry;
    ...
    public RemoteViewsFactory onGetViewFactory(Intent intent) {
        return new RemoteViewsFactory() {
            ...
            public RemoteViews getViewAt(int position) {
                ...
                RemoteViews views = new RemoteViews(getPackageName(), R.layout.ingredient_item);

                String ingredientDisplayText = data.getString(INDEX_INGREDIENT_NAME) + " (" + data.getInt(INDEX_INGREDIENT_QUANTITY)
                        + " " + data.getString(INDEX_INGREDIENT_MEASURE) + ")";
                views.setTextViewText(R.id.ingredient_item_text, ingredientDisplayText);
            ...
            public RemoteViews getLoadingView() {
                return new RemoteViews(getPackageName(), R.layout.ingredient_item);
            }
